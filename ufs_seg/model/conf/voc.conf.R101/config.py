...
C.log_dir = osp.abspath(osp.join(C.root_dir, 'log', 'voc_conf_R101_fineturn'))
...
C.dataset_path = "/semantic/datasets/pascal_VOC_2012/VOCdevkit/VOC2012/"
C.img_root_folder = osp.join(C.dataset_path, "JPEGImages")
C.gt_root_folder = osp.join(C.dataset_path, "test_gt")
C.train_source = '/semantic/datasets/pascal_VOC_2012/VOC_aug/test.txt'
C.eval_source = '/semantic/datasets/pascal_VOC_2012/VOC_aug/test.txt'
